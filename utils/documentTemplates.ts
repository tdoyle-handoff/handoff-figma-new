...
export const DOCUMENT_TEMPLATES: DocumentTemplate[] = [
    ...
    sections: [
      {
        ...
        description: 'Information about the seller and purchaser',
        fields: ['sellerName', 'sellerAddress', 'buyerName', 'buyerAddress']
      },
      {
        id: 'property',
        title: 'Property to be Sold',
        description: 'Details about the property being purchased',
        fields: ['propertyAddress', 'city', 'county', 'state', 'lotSize']
      },
      {
        id: 'items',
        title: 'Items Included/Excluded',
        description: 'Items included and excluded from the sale',
        fields: ['itemsIncluded', 'itemsExcluded']
      },
      {
        id: 'purchase-price',
        title: 'Purchase Price',
        description: 'Payment terms and amounts',
        fields: ['purchasePrice', 'depositAmount', 'additionalDeposit', 'additionalDepositDate', 'cashAtClosing', 'otherPayment']
      },
      {
        id: 'mortgage',
        title: 'Mortgage Contingency',
        description: 'Mortgage financing details',
        fields: ['mortgageAmount', 'mortgageTerm', 'interestRate', 'mortgageType', 'businessDaysToApply', 'mortgageContingencyDate', 'sellerContribution']
      },
      {
        id: 'other-terms',
        title: 'Other Terms',
      ...
      },
      {
        ...
        description: 'Title insurance and property use',
        fields: ['titleInsurance', 'intendedUse']
      },
      {
        id: 'closing',
        title: 'Transfer of Title/Possession',
        description: 'Closing date and arrangements',
        fields: ['closingDate']
      },
      {
        id: 'inspections',
        title: 'Inspections',
        description: 'Property inspection requirements',
        fields: ['structuralInspection', 'pestInspection', 'septicInspection', 'wellWaterTest', 'radonInspection', 'inspectionDate']
      },
      {
        id: 'contact-info',
        title: 'Contact Information',
        description: 'Attorney and party contact details',
        fields: ['purchaserAttorney', 'sellerAttorney', 'purchaserEmail', 'sellerEmail', 'purchaserPhone', 'sellerPhone']
      }
    ],
    fields: [
      // Parties
    ...
    sections: [
      {
        ...
        description: 'Information about the parties and property',
        fields: ['sellerName', 'buyerName', 'propertyAddress', 'contractDate']
      },
      {
        id: 'distribution',
        title: 'Distribution of Funds',
        description: 'How deposits and funds will be distributed',
        fields: ['distributionDetails']
      },
      {
        id: 'signatures',
        title: 'Signatures',
        description: 'Seller and buyer signatures with dates',
        fields: ['sellerSignature', 'sellerDate', 'buyerSignature', 'buyerDate']
      }
    ],
    fields: [
  ...
  
  {
    ...
    sections: [
      {
        id: 'reference',
        title: 'Original Offer Reference',
        description: 'Reference to the original purchase offer',
        fields: ['originalOfferDate', 'propertyAddress', 'sellerName', 'buyerName']
      },
      {
        id: 'counteroffer',
        title: 'Counteroffer Terms',
        description: 'Details of the counteroffer',
        fields: ['counterOfferTerms', 'expirationTime', 'expirationDate']
      },
      {
        id: 'response',
        title: 'Buyer Response',
        description: 'Buyer acceptance or rejection',
        fields: ['acceptanceType', 'additionalChanges']
      },
      {
        id: 'signatures',
        title: 'Signatures',
